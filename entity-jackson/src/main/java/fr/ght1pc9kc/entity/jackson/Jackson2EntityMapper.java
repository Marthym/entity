...
/**
 * Implementation of {@link EntityMapper} based on Jackson 2.
 * <p>
 ...
 *         .findAndRegisterModules()                                // Include JDK8 and JSR310 types
 *         .disable(SerializationFeature.WRITE_DATES_AS_TIMESTAMPS) // Avoid serializing dates as timestamps
 *         .registerModule(new EntityModule());                     // Required to handle Entity<?> structure
 *
